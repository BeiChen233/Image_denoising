a# -*- coding: utf-8 -*-
"""
Created on Fri Mar 15 17:14:34 2019
...
def test(model):
    ...
    for file in file_list:
        ...
        sigma_i = choice(args.sigma)
        # read image
        img_clean = np.array(Image.open(file), dtype='float32') / 255.0
        img_test = img_clean + np.random.normal(0, sigma_i/255.0, img_clean.shape)
        ...
        img_test.save(out_dir+filename+'_sigma'+'{}_psnr{:.2f}.png'.format(sigma_i, psnr_noise))
