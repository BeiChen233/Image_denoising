# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 10:02:23 2019
        ...
        for i in range(0, h_scaled-patch_size+1, stride):
            for j in range(0, w_scaled-patch_size+1, stride):
                ...
                for k in range(0, aug_times):
                    x_aug = data_augment(x, mode=np.random.randint(0,8))
...
if __name__ == '__main__':
    ...
    res = []
    # generate patches
    patch = map(generate_patches,file_list)
    #
    for x in patch:
        res += x
    
    print('Picture '+str(0)+' to '+str(len(file_list))+' are finished...')
